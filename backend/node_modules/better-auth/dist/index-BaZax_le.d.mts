...
import * as better_call185 from "better-call";
...
declare const openAPI: <O extends OpenAPIOptions>(options?: O | undefined) => {
  id: "open-api";
  endpoints: {
    generateOpenAPISchema: better_call185.StrictEndpoint<"/open-api/generate-schema", {
      method: "GET";
    } & {
      use: any[];
    }, {
    ...
    openAPIReference: better_call185.StrictEndpoint<"/reference", {
      method: "GET";
      metadata: {
        isAction: false;
      };
