...
declare const haveIBeenPwned: (options?: HaveIBeenPwnedOptions | undefined) => {
  id: "haveIBeenPwned";
  init(ctx: _better_auth_core9.AuthContext): {
    context: {
      password: {
        ...
        checkPassword: (userId: string, ctx: _better_auth_core9.GenericEndpointContext<_better_auth_core9.BetterAuthOptions>) => Promise<boolean>;
      };
    };
  };
  $ERROR_CODES: {
