  ...
  user: {
    fields: {
      username: {
        ...
        returned: true;
        transform: {
          input(value: _better_auth_core_db16.DBPrimitive): string | number | boolean | Date | unknown[] | Record<string, unknown> | null | undefined;
        };
      };
      displayUsername: {
        type: "string";
...
declare const username: (options?: UsernameOptions | undefined) => {
      ...
      databaseHooks: {
        user: {
          create: {
            ...
            } & Record<string, unknown>, context: _better_auth_core12.GenericEndpointContext | undefined): Promise<{
              data: {
  ...
  endpoints: {
    signInUsername: better_call177.StrictEndpoint<"/sign-in/username", {
      method: "POST";
      body: z.ZodObject<{
    ...
    isUsernameAvailable: better_call177.StrictEndpoint<"/is-username-available", {
      method: "POST";
      body: z.ZodObject<{
        username: z.ZodString;
      }, z.core.$strip>;
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call177.MiddlewareInputContext<better_call177.MiddlewareOptions>) => Promise<void>;
    }[];
  };
  $ERROR_CODES: {
    readonly INVALID_USERNAME_OR_PASSWORD: "Invalid username or password";
