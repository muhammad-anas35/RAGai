import { n as __export, r as __reExport } from "./chunk-DbI2OXuS.mjs";
import { t as KyselyDatabaseType } from "./types-CEepZ-RG.mjs";
import { a as LiteralNumber, c as OmitId, d as PrettifyDeep, f as Primitive, g as WithoutEmpty, h as UnionToIntersection, i as HasRequiredKeys, l as PreserveJSDoc, m as StripEmptyObjects, n as DeepPartial, o as LiteralString, p as RequiredKeysOf, r as Expand, s as LiteralUnion, t as Awaitable, u as Prettify$1 } from "./helper-DFzV6jvx.mjs";
import { n as InferPluginErrorCodes, t as InferOptionSchema } from "./plugins-Dmw3tk5H.mjs";
...
import { Account, BaseModelNames, BetterAuthDBSchema, BetterAuthPluginDBSchema, DBFieldAttribute, DBFieldAttributeConfig, DBFieldType, RateLimit, Session, Session as Session$1, User, User as User$1, Verification } from "@better-auth/core/db";
...
declare const createFieldAttribute: <T$1 extends DBFieldType, C$1 extends DBFieldAttributeConfig>(type: T$1, config?: C$1 | undefined) => {
  ...
  transform?: {
    input?: (value: _better_auth_core_db7.DBPrimitive) => _better_auth_core_db7.DBPrimitive | Promise<_better_auth_core_db7.DBPrimitive>;
    output?: (value: _better_auth_core_db7.DBPrimitive) => _better_auth_core_db7.DBPrimitive | Promise<_better_auth_core_db7.DBPrimitive>;
  } | undefined;
  references?: {
    model: string;
    field: string;
 ...
 * trustedOrigins.
 */
declare const originCheckMiddleware: (inputContext: better_call750.MiddlewareInputContext<better_call750.MiddlewareOptions>) => Promise<void>;
declare const originCheck: (getValue: (ctx: GenericEndpointContext) => string | string[]) => (inputContext: better_call750.MiddlewareInputContext<better_call750.MiddlewareOptions>) => Promise<void>;
//#endregion
//#region src/api/routes/account.d.ts
declare const listUserAccounts: better_call750.StrictEndpoint<"/list-accounts", {
  method: "GET";
...
declare const linkSocialAccount: better_call750.StrictEndpoint<"/link-social", {
  method: "POST";
  requireHeaders: true;
  body: z.ZodObject<{
...
declare const unlinkAccount: better_call750.StrictEndpoint<"/unlink-account", {
  method: "POST";
  body: z.ZodObject<{
...
declare const getAccessToken: better_call750.StrictEndpoint<"/get-access-token", {
  method: "POST";
  body: z.ZodObject<{
    providerId: z.ZodString;
    accountId: z.ZodOptional<z.ZodString>;
...
declare const refreshToken: better_call750.StrictEndpoint<"/refresh-token", {
  method: "POST";
  body: z.ZodObject<{
    providerId: z.ZodString;
    accountId: z.ZodOptional<z.ZodString>;
...
declare const accountInfo: better_call750.StrictEndpoint<"/account-info", {
  method: "GET";
  use: ((inputContext: better_call750.MiddlewareInputContext<better_call750.MiddlewareOptions>) => Promise<{
    session: {
      session: Record<string, any> & {
...
declare const callbackOAuth: better_call750.StrictEndpoint<"/callback/:id", {
  method: ("GET" | "POST")[];
  operationId: string;
...
declare const ok: better_call750.StrictEndpoint<"/ok", {
  method: "GET";
  metadata: {
    openapi: {
      description: string;
...
declare const requestPasswordReset: better_call750.StrictEndpoint<"/request-password-reset", {
  method: "POST";
  body: z.ZodObject<{
    email: z.ZodEmail;
...
declare const requestPasswordResetCallback: better_call750.StrictEndpoint<"/reset-password/:token", {
  method: "GET";
  operationId: string;
  query: z.ZodObject<{
...
declare const resetPassword: better_call750.StrictEndpoint<"/reset-password", {
  method: "POST";
  operationId: string;
  query: z.ZodOptional<z.ZodObject<{
...
declare const getSession: <Option extends BetterAuthOptions>() => better_call750.StrictEndpoint<"/get-session", {
  method: "GET";
  operationId: string;
  query: z.ZodOptional<z.ZodObject<{
 ...
 */
declare const sessionMiddleware: (inputContext: better_call750.MiddlewareInputContext<better_call750.MiddlewareOptions>) => Promise<{
  session: {
    session: Record<string, any> & {
      id: string;
      createdAt: Date;
 ...
 */
declare const sensitiveSessionMiddleware: (inputContext: better_call750.MiddlewareInputContext<better_call750.MiddlewareOptions>) => Promise<{
  session: {
    session: Record<string, any> & {
      id: string;
      createdAt: Date;
 ...
 */
declare const requestOnlySessionMiddleware: (inputContext: better_call750.MiddlewareInputContext<better_call750.MiddlewareOptions>) => Promise<{
  session: {
    session: Record<string, any> & {
      id: string;
      createdAt: Date;
 ...
 * is set to 0
 */
declare const freshSessionMiddleware: (inputContext: better_call750.MiddlewareInputContext<better_call750.MiddlewareOptions>) => Promise<{
  session: {
    session: Record<string, any> & {
      id: string;
      createdAt: Date;
 ...
 */
declare const listSessions: <Option extends BetterAuthOptions>() => better_call750.StrictEndpoint<"/list-sessions", {
  method: "GET";
  operationId: string;
  use: ((inputContext: better_call750.MiddlewareInputContext<better_call750.MiddlewareOptions>) => Promise<{
    session: {
 ...
 */
declare const revokeSession: better_call750.StrictEndpoint<"/revoke-session", {
  method: "POST";
  body: z.ZodObject<{
    token: z.ZodString;
  }, z.core.$strip>;
 ...
 */
declare const revokeSessions: better_call750.StrictEndpoint<"/revoke-sessions", {
  method: "POST";
  use: ((inputContext: better_call750.MiddlewareInputContext<better_call750.MiddlewareOptions>) => Promise<{
    session: {
      session: Record<string, any> & {
...
declare const revokeOtherSessions: better_call750.StrictEndpoint<"/revoke-other-sessions", {
  method: "POST";
  requireHeaders: true;
  use: ((inputContext: better_call750.MiddlewareInputContext<better_call750.MiddlewareOptions>) => Promise<{
    session: {
...
declare const signInSocial: <O extends BetterAuthOptions>() => better_call750.StrictEndpoint<"/sign-in/social", {
  method: "POST";
  operationId: string;
  body: z.ZodObject<{
    callbackURL: z.ZodOptional<z.ZodString>;
...
declare const signInEmail: <O extends BetterAuthOptions>() => better_call750.StrictEndpoint<"/sign-in/email", {
  method: "POST";
  operationId: string;
  body: z.ZodObject<{
    email: z.ZodString;
...
declare const signOut: better_call750.StrictEndpoint<"/sign-out", {
  method: "POST";
  operationId: string;
  requireHeaders: true;
  metadata: {
...
declare const signUpEmail: <O extends BetterAuthOptions>() => better_call750.StrictEndpoint<"/sign-up/email", {
  method: "POST";
  operationId: string;
...
declare const updateUser: <O extends BetterAuthOptions>() => better_call750.StrictEndpoint<"/update-user", {
  method: "POST";
  operationId: string;
  body: z.ZodRecord<z.ZodString, z.ZodAny>;
  use: ((inputContext: better_call750.MiddlewareInputContext<better_call750.MiddlewareOptions>) => Promise<{
...
declare const changePassword: better_call750.StrictEndpoint<"/change-password", {
  method: "POST";
  operationId: string;
  body: z.ZodObject<{
    newPassword: z.ZodString;
...
declare const setPassword: better_call750.StrictEndpoint<"/set-password", {
  method: "POST";
  body: z.ZodObject<{
    newPassword: z.ZodString;
  }, z.core.$strip>;
...
declare const deleteUser: better_call750.StrictEndpoint<"/delete-user", {
  method: "POST";
  use: ((inputContext: better_call750.MiddlewareInputContext<better_call750.MiddlewareOptions>) => Promise<{
    session: {
      session: Record<string, any> & {
...
declare const deleteUserCallback: better_call750.StrictEndpoint<"/delete-user/callback", {
  method: "GET";
  query: z.ZodObject<{
    token: z.ZodString;
    callbackURL: z.ZodOptional<z.ZodString>;
...
declare const changeEmail: better_call750.StrictEndpoint<"/change-email", {
  method: "POST";
  body: z.ZodObject<{
    newEmail: z.ZodEmail;
    callbackURL: z.ZodOptional<z.ZodString>;
...
declare function getEndpoints<Option extends BetterAuthOptions>(ctx: Promise<AuthContext> | AuthContext, options: Option): {
  api: {
    readonly ok: better_call750.StrictEndpoint<"/ok", {
      method: "GET";
      metadata: {
        openapi: {
          description: string;
    ...
    readonly error: better_call750.StrictEndpoint<"/error", {
      method: "GET";
      metadata: {
        openapi: {
          description: string;
    ...
    readonly signInSocial: better_call750.StrictEndpoint<"/sign-in/social", {
      method: "POST";
      operationId: string;
      body: z.ZodObject<{
        callbackURL: z.ZodOptional<z.ZodString>;
    ...
    readonly callbackOAuth: better_call750.StrictEndpoint<"/callback/:id", {
      method: ("GET" | "POST")[];
      operationId: string;
      body: z.ZodOptional<z.ZodObject<{
        code: z.ZodOptional<z.ZodString>;
    ...
    readonly getSession: better_call750.StrictEndpoint<"/get-session", {
      method: "GET";
      operationId: string;
      query: z.ZodOptional<z.ZodObject<{
        disableCookieCache: z.ZodOptional<z.ZodCoercedBoolean<unknown>>;
    ...
    readonly signOut: better_call750.StrictEndpoint<"/sign-out", {
      method: "POST";
      operationId: string;
      requireHeaders: true;
      metadata: {
    ...
    readonly signUpEmail: better_call750.StrictEndpoint<"/sign-up/email", {
      method: "POST";
      operationId: string;
      body: z.ZodRecord<z.ZodString, z.ZodAny>;
      metadata: {
    ...
    readonly signInEmail: better_call750.StrictEndpoint<"/sign-in/email", {
      method: "POST";
      operationId: string;
      body: z.ZodObject<{
        email: z.ZodString;
    ...
    readonly resetPassword: better_call750.StrictEndpoint<"/reset-password", {
      method: "POST";
      operationId: string;
      query: z.ZodOptional<z.ZodObject<{
        token: z.ZodOptional<z.ZodString>;
    ...
    readonly verifyEmail: better_call750.StrictEndpoint<"/verify-email", {
      method: "GET";
      operationId: string;
      query: z.ZodObject<{
        token: z.ZodString;
    ...
    readonly sendVerificationEmail: better_call750.StrictEndpoint<"/send-verification-email", {
      method: "POST";
      operationId: string;
      body: z.ZodObject<{
        email: z.ZodEmail;
    ...
    readonly changeEmail: better_call750.StrictEndpoint<"/change-email", {
      method: "POST";
      body: z.ZodObject<{
        newEmail: z.ZodEmail;
        callbackURL: z.ZodOptional<z.ZodString>;
    ...
    readonly changePassword: better_call750.StrictEndpoint<"/change-password", {
      method: "POST";
      operationId: string;
      body: z.ZodObject<{
        newPassword: z.ZodString;
    ...
    readonly setPassword: better_call750.StrictEndpoint<"/set-password", {
      method: "POST";
      body: z.ZodObject<{
        newPassword: z.ZodString;
      }, zod_v4_core0.$strip>;
    ...
    readonly updateUser: better_call750.StrictEndpoint<"/update-user", {
      method: "POST";
      operationId: string;
      body: z.ZodRecord<z.ZodString, z.ZodAny>;
      use: ((inputContext: better_call750.MiddlewareInputContext<better_call750.MiddlewareOptions>) => Promise<{
    ...
    readonly deleteUser: better_call750.StrictEndpoint<"/delete-user", {
      method: "POST";
      use: ((inputContext: better_call750.MiddlewareInputContext<better_call750.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly requestPasswordReset: better_call750.StrictEndpoint<"/request-password-reset", {
      method: "POST";
      body: z.ZodObject<{
        email: z.ZodEmail;
        redirectTo: z.ZodOptional<z.ZodString>;
    ...
    readonly requestPasswordResetCallback: better_call750.StrictEndpoint<"/reset-password/:token", {
      method: "GET";
      operationId: string;
      query: z.ZodObject<{
        callbackURL: z.ZodString;
    ...
    readonly listSessions: better_call750.StrictEndpoint<"/list-sessions", {
      method: "GET";
      operationId: string;
      use: ((inputContext: better_call750.MiddlewareInputContext<better_call750.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly revokeSession: better_call750.StrictEndpoint<"/revoke-session", {
      method: "POST";
      body: z.ZodObject<{
        token: z.ZodString;
      }, zod_v4_core0.$strip>;
    ...
    readonly revokeSessions: better_call750.StrictEndpoint<"/revoke-sessions", {
      method: "POST";
      use: ((inputContext: better_call750.MiddlewareInputContext<better_call750.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly revokeOtherSessions: better_call750.StrictEndpoint<"/revoke-other-sessions", {
      method: "POST";
      requireHeaders: true;
      use: ((inputContext: better_call750.MiddlewareInputContext<better_call750.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly linkSocialAccount: better_call750.StrictEndpoint<"/link-social", {
      method: "POST";
      requireHeaders: true;
      body: z.ZodObject<{
        callbackURL: z.ZodOptional<z.ZodString>;
    ...
    readonly listUserAccounts: better_call750.StrictEndpoint<"/list-accounts", {
      method: "GET";
      use: ((inputContext: better_call750.MiddlewareInputContext<better_call750.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly deleteUserCallback: better_call750.StrictEndpoint<"/delete-user/callback", {
      method: "GET";
      query: z.ZodObject<{
        token: z.ZodString;
        callbackURL: z.ZodOptional<z.ZodString>;
    ...
    readonly unlinkAccount: better_call750.StrictEndpoint<"/unlink-account", {
      method: "POST";
      body: z.ZodObject<{
        providerId: z.ZodString;
        accountId: z.ZodOptional<z.ZodString>;
    ...
    readonly refreshToken: better_call750.StrictEndpoint<"/refresh-token", {
      method: "POST";
      body: z.ZodObject<{
        providerId: z.ZodString;
        accountId: z.ZodOptional<z.ZodString>;
    ...
    readonly getAccessToken: better_call750.StrictEndpoint<"/get-access-token", {
      method: "POST";
      body: z.ZodObject<{
        providerId: z.ZodString;
        accountId: z.ZodOptional<z.ZodString>;
    ...
    readonly accountInfo: better_call750.StrictEndpoint<"/account-info", {
      method: "GET";
      use: ((inputContext: better_call750.MiddlewareInputContext<better_call750.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
...
//#endregion
export { createEmailVerificationToken as $, InferUserFromClient as $t, deleteUser as A, InferValueType as An, InferAPI as At, getSessionFromCtx as B, Where$1 as Bt, createAuthEndpoint$1 as C, FieldAttributeToObject as Cn, generateId as Ct, router as D, InferFieldsInput as Dn, betterAuth as Dt, optionsMiddleware as E, InferFieldsFromPlugins as En, parseState as Et, signOut as F, DBAdapter$1 as Ft, revokeSessions as G, ClientOptions as Gt, requestOnlySessionMiddleware as H, BetterAuthClientOptions$1 as Ht, signInEmail as I, DBAdapterInstance$1 as It, requestPasswordReset as J, InferAdditionalFromClient as Jt, sensitiveSessionMiddleware as K, ClientStore as Kt, signInSocial as L, DBAdapterSchemaCreation$1 as Lt, setPassword as M, createFieldAttribute as Mn, Adapter as Mt, updateUser as N, getAdapter as Nn, AdapterInstance as Nt, changeEmail as O, InferFieldsInputClient as On, FilterActions as Ot, signUpEmail as P, getBaseAdapter as Pn, AdapterSchemaCreation as Pt, error as Q, InferSessionFromClient as Qt, freshSessionMiddleware as R, DBTransactionAdapter$1 as Rt, checkEndpointConflicts as S, convertToDB as Sn, capitalizeFirstLetter as St, getEndpoints as T, InferFieldsFromOptions as Tn, generateState as Tt, revokeOtherSessions as U, BetterAuthClientPlugin$1 as Ut, listSessions as V, AtomListener as Vt, revokeSession as W, ClientAtomListener as Wt, resetPassword as X, InferErrorCodes as Xt, requestPasswordResetCallback as Y, InferClientAPI as Yt, ok as Z, InferPluginsFromClient as Zt, User$1 as _, getAuthTables as _n, TelemetryEvent as _t, BetterAuthRateLimitOptions as a, FieldAttributeToSchema as an, getAccessToken as at, AuthEndpoint as b, matchType as bn, getTelemetryAuthConfig as bt, AdditionalSessionFieldsInput as c, parseAccountInput as cn, refreshToken as ct, AdditionalUserFieldsOutput as d, parseInputData as dn, originCheckMiddleware as dt, IsSignal as en, sendVerificationEmail as et, InferPluginTypes as f, parseSessionInput as fn, getOAuthState as ft, Session$1 as g, createInternalAdapter as gn, StandardSchemaV1$1 as gt, RateLimit as h, parseUserOutput as hn, JWTPayload$1 as ht, BetterAuthPlugin$1 as i, getWithHooks as in, accountInfo as it, deleteUserCallback as j, PluginFieldAttribute as jn, InferSessionAPI as jt, changePassword as k, InferFieldsOutput as kn, FilteredAPI as kt, AdditionalSessionFieldsOutput as l, parseAccountOutput as ln, unlinkAccount as lt, InferUser as m, parseUserInput as mn, JSONWebKeySet$1 as mt, BetterAuthCookies$1 as n, Store as nn, verifyEmail as nt, Auth as o, toZodSchema as on, linkSocialAccount as ot, InferSession as p, parseSessionOutput as pn, getIp as pt, sessionMiddleware as q, InferActions as qt, BetterAuthOptions$1 as r, InferRoute as rn, callbackOAuth as rt, Account as s, mergeSchema as sn, listUserAccounts as st, BetterAuthAdvancedOptions as t, SessionQueryParams as tn, sendVerificationEmailFn as tt, AdditionalUserFieldsInput as u, parseAdditionalUserInput as un, originCheck as ut, Verification as v, getSchema as vn, createTelemetry$1 as vt, createAuthMiddleware$1 as w, InferAdditionalFieldsFromPluginOptions as wn, HIDE_METADATA as wt, AuthMiddleware as x, convertFromDB as xn, index_d_exports as xt, APIError$1 as y, getMigrations as yn, getCurrentAdapter$1 as yt, getSession as z, TransactionAdapter as zt };