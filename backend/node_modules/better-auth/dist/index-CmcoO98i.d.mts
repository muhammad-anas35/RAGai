import { _ as User, g as Session } from "./index-COnelCGa.mjs";
import { GenericEndpointContext } from "@better-auth/core";
import * as better_call187 from "better-call";
...
declare const oneTimeToken: (options?: OneTimeTokenOptions | undefined) => {
  ...
  endpoints: {
     ...
     */
    generateOneTimeToken: better_call187.StrictEndpoint<"/one-time-token/generate", {
      method: "GET";
      use: ((inputContext: better_call187.MiddlewareInputContext<better_call187.MiddlewareOptions>) => Promise<{
        session: {
     ...
     */
    verifyOneTimeToken: better_call187.StrictEndpoint<"/one-time-token/verify", {
      method: "POST";
      body: z.ZodObject<{
        token: z.ZodString;
      }, z.core.$strip>;
