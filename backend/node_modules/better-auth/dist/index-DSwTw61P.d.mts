...
import * as better_call198 from "better-call";
...
declare const oAuthProxy: (opts?: OAuthProxyOptions | undefined) => {
  ...
  endpoints: {
    oAuthProxy: better_call198.StrictEndpoint<"/oauth-proxy-callback", {
      method: "GET";
      operationId: string;
      query: z.ZodObject<{
      ...
      use: ((inputContext: better_call198.MiddlewareInputContext<better_call198.MiddlewareOptions>) => Promise<void>)[];
      metadata: {
        openapi: {
          operationId: string;
          description: string;
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call198.MiddlewareInputContext<better_call198.MiddlewareOptions>) => Promise<void>;
    }[];
    after: {
      matcher(context: _better_auth_core18.HookEndpointContext): boolean;
      handler: (inputContext: better_call198.MiddlewareInputContext<better_call198.MiddlewareOptions>) => Promise<void>;
