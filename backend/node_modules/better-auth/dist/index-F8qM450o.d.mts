import { _ as User$1, g as Session$1, wn as InferAdditionalFieldsFromPluginOptions } from "./index-COnelCGa.mjs";
import { d as PrettifyDeep, o as LiteralString } from "./helper-DFzV6jvx.mjs";
import { t as InferOptionSchema } from "./plugins-Dmw3tk5H.mjs";
import { a as Role, c as Subset, i as AccessControl, o as Statements, t as AuthorizeResponse } from "./index-rnNTrfA7.mjs";
...
declare const defaultAc: {
  newRole<K$1 extends "ac" | "organization" | "member" | "invitation" | "team">(statements: Subset<K$1, {
    readonly organization: readonly ["update", "delete"];
    readonly member: readonly ["create", "update", "delete"];
    readonly invitation: readonly ["create", "cancel"];
    readonly team: readonly ["create", "update", "delete"];
...
declare const adminAc: {
  authorize<K$1 extends "ac" | "organization" | "member" | "invitation" | "team">(request: K$1 extends infer T extends keyof Subset<"ac" | "organization" | "member" | "invitation" | "team", {
    readonly organization: readonly ["update", "delete"];
    readonly member: readonly ["create", "update", "delete"];
    readonly invitation: readonly ["create", "cancel"];
    readonly team: readonly ["create", "update", "delete"];
    readonly ac: readonly ["create", "read", "update", "delete"];
  }> ? { [key in T]?: Subset<"ac" | "organization" | "member" | "invitation" | "team", {
    readonly organization: readonly ["update", "delete"];
    readonly member: readonly ["create", "update", "delete"];
    readonly invitation: readonly ["create", "cancel"];
    readonly team: readonly ["create", "update", "delete"];
    ...
    actions: Subset<"ac" | "organization" | "member" | "invitation" | "team", {
      readonly organization: readonly ["update", "delete"];
      readonly member: readonly ["create", "update", "delete"];
      readonly invitation: readonly ["create", "cancel"];
      readonly team: readonly ["create", "update", "delete"];
  ...
  statements: Subset<"ac" | "organization" | "member" | "invitation" | "team", {
    readonly organization: readonly ["update", "delete"];
    readonly member: readonly ["create", "update", "delete"];
    readonly invitation: readonly ["create", "cancel"];
    readonly team: readonly ["create", "update", "delete"];
...
//#endregion
export { getClient as $, TeamMemberInput as A, OrganizationOptions as B, Organization as C, Team as D, OrganizationSchema as E, organizationRoleSchema as F, memberAc as G, defaultAc as H, organizationSchema as I, getMCPProviderMetadata as J, ownerAc as K, roleSchema as L, invitationSchema as M, invitationStatus as N, TeamInput as O, memberSchema as P, withMcpAuth as Q, teamMemberSchema as R, MemberInput as S, OrganizationRole as T, defaultRoles as U, adminAc as V, defaultStatements as W, oAuthDiscoveryMetadata as X, mcp as Y, oAuthProtectedResourceMetadata as Z, InferTeam as _, admin as _t, optionsMiddleware as a, OAuthAccessToken as at, InvitationStatus as b, SessionWithImpersonatedBy as bt, OrganizationPlugin as c, TokenBody as ct, parseRoles as d, API_KEY_TABLE_NAME as dt, getMetadata as et, InferInvitation as f, ERROR_CODES as ft, InferOrganizationZodRolesFromOption as g, ApiKeyOptions as gt, InferOrganizationRolesFromOption as h, ApiKey as ht, createAuthMiddleware$1 as i, CodeVerificationValue as it, defaultRolesSchema as j, TeamMember as k, TeamEndpoints as l, LastLoginMethodOptions as lt, InferOrganization as m, defaultKeyHasher as mt, AuthMiddleware as n, AuthorizationQuery as nt, DynamicAccessControlEndpoints as o, OIDCMetadata as ot, InferMember as p, apiKey as pt, getMCPProtectedResourceMetadata as q, createAuthEndpoint$1 as r, Client as rt, OrganizationEndpoints as s, OIDCOptions as st, AuthEndpoint as t, oidcProvider as tt, organization as u, lastLoginMethod as ut, Invitation as v, AdminOptions as vt, OrganizationInput as w, Member as x, UserWithRole as xt, InvitationInput as y, InferAdminRolesFromOption as yt, teamSchema as z };