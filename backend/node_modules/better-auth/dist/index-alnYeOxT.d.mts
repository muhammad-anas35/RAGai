...
declare const phoneNumber: (options?: PhoneNumberOptions | undefined) => {
  ...
  hooks: {
    before: {
      matcher: (ctx: _better_auth_core17.HookEndpointContext) => boolean;
      handler: (inputContext: better_call191.MiddlewareInputContext<better_call191.MiddlewareOptions>) => Promise<never>;
    }[];
  };
  endpoints: {
    /**
     ...
     */
    signInPhoneNumber: better_call191.StrictEndpoint<"/sign-in/phone-number", {
      method: "POST";
      body: z.ZodObject<{
     ...
     */
    sendPhoneNumberOTP: better_call191.StrictEndpoint<"/phone-number/send-otp", {
      method: "POST";
      body: z.ZodObject<{
        phoneNumber: z.ZodString;
      }, z.core.$strip>;
     ...
     */
    verifyPhoneNumber: better_call191.StrictEndpoint<"/phone-number/verify", {
      method: "POST";
      body: z.ZodObject<{
        phoneNumber: z.ZodString;
        code: z.ZodString;
    ...
    requestPasswordResetPhoneNumber: better_call191.StrictEndpoint<"/phone-number/request-password-reset", {
      method: "POST";
      body: z.ZodObject<{
        phoneNumber: z.ZodString;
      }, z.core.$strip>;
    ...
    resetPasswordPhoneNumber: better_call191.StrictEndpoint<"/phone-number/reset-password", {
      method: "POST";
      body: z.ZodObject<{
        otp: z.ZodString;
        phoneNumber: z.ZodString;
