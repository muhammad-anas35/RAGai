...
declare const multiSession: (options?: MultiSessionConfig | undefined) => {
  ...
  endpoints: {
     ...
     */
    listDeviceSessions: better_call40.StrictEndpoint<"/multi-session/list-device-sessions", {
      method: "GET";
      requireHeaders: true;
    } & {
      use: any[];
     ...
     */
    setActiveSession: better_call40.StrictEndpoint<"/multi-session/set-active", {
      method: "POST";
      body: z.ZodObject<{
        sessionToken: z.ZodString;
      }, z.core.$strip>;
      requireHeaders: true;
      use: ((inputContext: better_call40.MiddlewareInputContext<better_call40.MiddlewareOptions>) => Promise<{
        session: {
     ...
     */
    revokeDeviceSession: better_call40.StrictEndpoint<"/multi-session/revoke", {
      method: "POST";
      body: z.ZodObject<{
        sessionToken: z.ZodString;
      }, z.core.$strip>;
  ...
  hooks: {
    after: {
      ...
      handler: (inputContext: better_call40.MiddlewareInputContext<better_call40.MiddlewareOptions>) => Promise<void>;
    }[];
  };
  $ERROR_CODES: {
